...
<div class="data">
      <el-table
        ...
        :data="searchDta.slice((currentPage-1)*pagesize,currentPage*pagesize)"
      >
        <el-table-column sortable prop="id" label="序号" width="80"></el-table-column>
        <el-table-column prop="title" class="title" label="名称" width="300"></el-table-column>
        <el-table-column sortable prop="price" label="价格" width="80"></el-table-column>
        <el-table-column sortable prop="number" label="数量" width="80"></el-table-column>
        <el-table-column prop="img" label="图片" width="200">
          <template slot-scope="scope">
            <img :src="url+scope.row.bigimg" min-width="70" height="70" />
          </template>
        </el-table-column>
        <el-table-column prop="state" label="状态" width="120"></el-table-column>
        <el-table-column prop="cop" label="操作">
          <el-button size="mini" type="danger">查看商品</el-button>
        </el-table-column>
      </el-table>
    </div>
    <el-pagination
...
<script>
// import Pagination from "@/universalComponents/pagination.vue";
