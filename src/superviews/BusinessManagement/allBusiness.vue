...
<div class="data">
      ...
      >
        ...
        <el-table-column sortable prop="createtime" label="创建时间" width="80"></el-table-column>
        <el-table-column sortable prop="state" label="状态" width="80"></el-table-column>
        <el-table-column prop="cop" label="操作">
          <el-button size="mini" type="success">查看分享</el-button>
          <el-button size="mini" type="danger">回复分享</el-button>
        </el-table-column>
      </el-table>
    </div>
    <el-pagination
